...
public class View extends JFrame {
    ...
    private final Color textSub = Color.decode("#abd1c6");
...
//       tab ma hoa doi xung
        ...
        JPanel panelTop1 = new JPanel(new GridLayout(3, 2, 15, 5));
		JLabel lbMethod1 = new JLabel("Các kiểu thao tác");
		JLabel lbKey1 = new JLabel("Khoá (key)");
		String[] arrModes = {"ECB", "CBC", "PCBC", "CFB", "OFB", "CTR"};
        JComboBox<String> cbModes = new JComboBox<>(arrModes);
...
//        key
		...
		JPanel panelKey1 = new JPanel(new FlowLayout(FlowLayout.RIGHT,5,0));
		panelKey1.add(new Label("Độ dài khoá:"));
		panelKey1.add(jSpinnerLenght1);
		panelKey1.add(creatKey1);
		panelKey1.add(btnInputKey1);
		panelKey1.add(btnOutputKey1);
		JPanel keyGroup1 = new JPanel(new BorderLayout(5,0));
		keyGroup1.add(key1,BorderLayout.CENTER);
		keyGroup1.add(panelKey1,BorderLayout.EAST);
		...
		pnInput1.setLayout(new BorderLayout());
		...
		pnInput1.add(textInputFile,BorderLayout.CENTER);
